...
const chat_names = ["Amit Aggarwal", "Sunaina Singh", "Lovely Kapoor", "Aryav Garg", "Aman Jain", "Rashi Chauhan", "Sanjay Dhingra"];
const chat_names_length = chat_names.length;
const chat_msg = ["Why didn't you tell me about your prob...",
    "Perfect, I am happy you are fine! Stay saf...",
    "I am sorry. I don't know about this. Check with Mi...",
    "Congratulations. Everything is sorted now..."];
